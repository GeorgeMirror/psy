			...
			<section class="section breadcrumb-wrapper">
				<div class="shell">
					...
					<ol class="breadcrumb-custom">
						...
						<li><a href="login-register.html#">Pages</a></li>
						<li class="active">Log In/Register
						</li>
					</ol>
				</div>
			</section>
						...
						<div class="cell-sm-10 cell-md-8 cell-lg-4">
							...
							<div class="tabs-custom tabs-horizontal" id="tabs-1">
								...
								<ul class="nav-custom nav-custom-tabs nav-custom-tabs-inline">
									<li class="active"><a href="login-register.html#tabs-1-1" data-toggle="tab">Login</a></li>
									<li><a href="login-register.html#tabs-1-2" data-toggle="tab">Registration</a></li>
								</ul>
							</div>
						</div>
					</div>
								...
								<div class="tab-pane fade in active" id="tabs-1-1">
									...
									<form class="rd-mailform text-left">
										...
										<ul class="group-md group-middle">
											...
											<li>
												<ul class="group-sm">
													<li><a class="icon icon-md icon-circle icon-default fa-facebook" href="login-register.html#"></a></li>
													<li><a class="icon icon-md icon-circle icon-default fa-twitter" href="login-register.html#"></a></li>
												</ul>
											</li>
										</ul>
									</form>
