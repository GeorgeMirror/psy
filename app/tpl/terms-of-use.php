			...
			<section class="section breadcrumb-wrapper">
				<div class="shell">
					...
					<ol class="breadcrumb-custom">
						...
						<li><a href="terms-of-use.html#">Pages</a></li>
						<li><a href="terms-of-use.html#">Extras</a></li>
						<li class="active">Terms of Use
						</li>
					</ol>
				</div>
			</section>
			...
			<section class="section section-lg bg-white">
				<div class="shell shell-wide">
					<div class="range range-xs-center">
						<div class="cell-sm-10c cell-md-8 cell-xl-6">
							<dl class="list-terms">
							...
							</dl><a class="button button-primary" href="contacts.html">contact us</a>
						</div>
					</div>
				</div>
			</section>
